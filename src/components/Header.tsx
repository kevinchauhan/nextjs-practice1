...
const Header = () => {
  ...
  */}
                    ...
                    <Link href="/profile" className="text-sm font-semibold leading-6 text-gray-900">Profile</Link>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-2">
                    ...
                    <Link href="/signup" className="text-sm font-semibold leading-6 text-gray-900">Sign up</Link>
                </div>
            </nav>
        </header>
